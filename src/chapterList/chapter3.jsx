...
import questionsData from '../../dataBank/chapter3.json'
import './chapter3.css'
...
function Chapter3() {
  ...
  const handleNext = () => {
    if (currentQuestionIndex < questionsData.length - 1) {
      ...
      const existingData = localStorage.getItem('quiz_chapter3')
      ...
      localStorage.setItem('quiz_chapter3', JSON.stringify({
        score: finalScore,
