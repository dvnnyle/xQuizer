...
import questionsData from '../../dataBank/dataSub/quizInc3.json'
import '../chapterList/chapter3.css'

function QuizFindIncorrect3() {
  ...
  const handleNext = () => {
    if (currentQuestionIndex < questionsData.length - 1) {
      ...
      const existingData = localStorage.getItem('quiz_findincorrect3')
      ...
      localStorage.setItem('quiz_findincorrect3', JSON.stringify({
        score: score,
        ...
        >
          ...
          <div className="quiz-container">
            <div className="quiz-header">
              <h2>Answer Review - Find Incorrect 3</h2>
                ...
                return (
                  <div key={question.id} className="review-question-card">
                    ...
                    <div className="review-explanation">
                      ...
                      <p className="explanation-text" dangerouslySetInnerHTML={{ __html: question.explanation }}></p>
                    </div>
                  </div>
                )
              })}
  ...
  return (
    ...
    >
      ...
      <div className="quiz-container">
        <div className="quiz-header">
          <h2>Find Incorrect 3 - Challenge Quiz</h2>
          <div className="progress-info">
          ...
          <div className="streak-center">
            {streak > 0 && <div className="streak-fire">🔥 {streak} Streak!</div>}
          </div>
        ...
        <div className="question-card">
          <div className="section-badge">Question {currentQuestionIndex + 1}</div>
          <h3 className="question-text">{currentQuestion.question}</h3>
          <p style={{ color: '#fbbf24', fontSize: '0.9rem', marginBottom: '1rem' }}>
            ⚠️ Select the INCORRECT statement
          </p>
          ...
          {selectedAnswer !== null && (
            <div className="explanation-box">
              ...
              <div className="correct-answer">
                The incorrect statement is: {currentQuestion.answer}
              </div>
              <p className="explanation-text" dangerouslySetInnerHTML={{ __html: currentQuestion.explanation }}></p>
            </div>
          )}
...
export default QuizFindIncorrect3
