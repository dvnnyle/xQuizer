...
import questionsData from '../../dataBank/dataSub/quizInc4.json'
import '../chapterList/chapter3.css'

function QuizFindIncorrect4() {
  ...
  const handleNext = () => {
    if (currentQuestionIndex < questionsData.length - 1) {
      ...
      const existingData = localStorage.getItem('quiz_findincorrect4')
      ...
      localStorage.setItem('quiz_findincorrect4', JSON.stringify({
        score: score,
        ...
        >
          ...
          <div className="quiz-container">
            <div className="quiz-header">
              <h2>Answer Review - Find Incorrect 4</h2>
  ...
  return (
    ...
    >
      ...
      <div className="quiz-container">
        <div className="quiz-header">
          <h2>Find Incorrect 4 - Challenge Quiz</h2>
          <div className="progress-info">
...
export default QuizFindIncorrect4
