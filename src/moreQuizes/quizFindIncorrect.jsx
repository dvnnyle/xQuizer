...
import questionsData from '../../dataBank/dataSub/quizInc.json'
import '../chapterList/chapter3.css'

function QuizFindIncorrect() {
  ...
  const handleNext = () => {
    if (currentQuestionIndex < questionsData.length - 1) {
      ...
      const existingData = localStorage.getItem('quiz_findincorrect')
      ...
      localStorage.setItem('quiz_findincorrect', JSON.stringify({
        score: finalScore,
        ...
        >
          ...
          <div className="quiz-container">
            <div className="quiz-header">
              <h2>Answer Review - Find Incorrect Statement</h2>
  ...
  return (
    ...
    >
      ...
      <div className="quiz-container">
        <div className="quiz-header">
          <h2>Find the Incorrect Statement Quiz</h2>
          <div className="progress-info">
...
export default QuizFindIncorrect
