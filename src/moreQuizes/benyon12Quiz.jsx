...
function Benyon12Quiz() {
  ...
  const handleNext = () => {
    if (currentQuestionIndex < questionsData.length - 1) {
      ...
      const existingData = localStorage.getItem('quiz_benyon12')
      ...
      localStorage.setItem('quiz_benyon12', JSON.stringify({
        score: finalScore,
        ...
        >
          ...
          <div className="quiz-container">
            <div className="quiz-header">
              <h2>Answer Review - Benyon's 12 Principles</h2>
  ...
  return (
    ...
    >
      ...
      <div className="quiz-container">
        <div className="quiz-header">
          <h2>Benyon's 12 Principles Quiz</h2>
          <div className="progress-info">
